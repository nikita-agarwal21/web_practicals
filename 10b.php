...
<form action=10b.php method=POST>
...
{
try{
      $con="mysql:host=localhost;dbname=students";
...
try{
     $student_data=array();
     $con="mysql:host=localhost;dbname=students"; $pdo=new    PDO($con,"root",""); $sql="SELECT * from student"; $result=$pdo->query($sql); $cnt=0;
